...
class Greedy(SpinSolver):
    ...
    def step(self, random_weight):
        ...
        observation, reward, done, _ = self.env.step(action, random_weight, adj_mask=True)
...
class Random(SpinSolver):
    ...
    def step(self, random_weight):
        ...
        observation, reward, done, _ = self.env.step(self.env.action_space.sample(), random_weight, adj_mask=True)
        return reward, done
...
class Network(SpinSolver):
    ...
    def step(self):
        ...
        if action is not None:
            observation, reward, done, _ = self.env.step(action, adj_mask=True)
